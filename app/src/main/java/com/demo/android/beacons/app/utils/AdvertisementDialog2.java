...
public class AdvertisementDialog2 extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle saveInstanceState) {
        ...
        View view = inflater.inflate(R.layout.dialog_advertisement_2, container);
        initComponents(view);
        return view;
    }
